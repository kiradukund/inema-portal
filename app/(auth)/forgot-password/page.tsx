        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-slate-500 text-sm">We sent a reset link to <strong>{email}</strong>. Check your inbox and spam.</p>
            ...
            <>
              ...
              <input type="email" className="input mb-4" placeholder="you@email.com" value={email}
                onChange={e => setEmail(e.target.value)} onKeyDown={e => e.key==='Enter' && submit()} />
              <button className="btn-gold w-full" onClick={submit} disabled={loading}>{loading ? 'Sending...' : 'Send Reset Link'}</button>
