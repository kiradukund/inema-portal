    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
          {!ready ? (
            <p className="text-slate-500 text-sm text-center">Loading reset link... If this takes too long, request a new reset email.</p>
          ) : (
            <>
              ...
              <input type="password" className="input mb-3" placeholder="Minimum 8 characters"
                value={password} onChange={e => setPassword(e.target.value)} />
              <label className="label">Confirm Password</label>
              <input type="password" className="input mb-5" placeholder="Repeat password"
