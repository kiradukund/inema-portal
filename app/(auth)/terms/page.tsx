    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 space-y-6 text-sm text-slate-700 leading-relaxed">
          {[
            ['1. About INEMA', 'INEMA Financial Solutions Ltd is a non-deposit-taking moneylender licensed by the National Bank of Rwanda (BNR) under Category III. Registered with RDB, located at Town Center Building, Floor 3B, Downtown Kigali, Rwanda.'],
            ...
            ['8. Contact', 'INEMA Financial Solutions Ltd · Town Center Building, Floor 3B, Downtown Kigali · inemafinancialsolutionsltd@gmail.com · +250 788 834 132'],
          ].map(([title, body]) => (
            <section key={title}>
